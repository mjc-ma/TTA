...
def load_experiments_features(feature_maps_paths, block, feature_type, t):
    ...
    for i, feature_maps_path in enumerate(feature_maps_paths):
        if "attn" in feature_type:
            ...
            feature_map = feature_map.reshape(feature_map.shape[0], -1).t()  # N X C 256,1280
            # print('feature_map.shape', feature_map.shape)
        feature_maps.append(feature_map)
        # print('feature_maps.size', feature_maps.shape)
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        nargs="?",
        default="/home/majc/TTA/plug-and-play/configs/pnp/feature-pca-vis.yaml",
